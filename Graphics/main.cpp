...
GLuint generateObjectBuffer(GLuint VBO, GLfloat vertices[], GLfloat colors[], GLuint numVertices) {
...
void init()
{
	...
	generateObjectBuffer(vertices, colors, 3);
	linkCurrentBuffertoShader(shaderProgramID, 3);
}
